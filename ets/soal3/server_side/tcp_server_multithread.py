...
alldata['5']=dict(nomor=5, nama="harry maguire", posisi="bek tengah kiri")
alldata['6']=dict(nomor=6, nama="paul pogba", posisi="gelandang")
alldata['7']=dict(nomor=7, nama="cristiano ronaldo", posisi="penyerang")
alldata['8']=dict(nomor=8, nama="juan mata", posisi="gelandang")
alldata['9']=dict(nomor=9, nama="karim benzema", posisi="penyerang")
alldata['10']=dict(nomor=10, nama="lionel messi", posisi="penyerang")
...
def run_server(server_address,is_secure=False):
    ...
    while True:
        ...
        try:
            ...
            threads[ctr] = threading.Thread(target=myconnection, args=(connection, client_address))
            threads[ctr].start()
            ctr = ctr + 1
...
def myconnection(connection, client_address):
    selesai=False
